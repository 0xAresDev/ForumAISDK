...
from ModelMarketSDK.ModelMarket import Mixtral8x7BSaakuruMainnet, Mixtral8x7BSkaleTestnet
...
model_market = Mixtral8x7BSkaleTestnet(os.environ.get("PRIVATE_KEY"), os.environ.get("PUBLIC_KEY"))
